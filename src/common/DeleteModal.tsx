...
export default function DeleteModal({ toggleModal, open, onDelete }: ModalProps) {
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Are you sure you want to delete this listing? All of the data will be permanently
