...
export default function DeleteAccountModal({ toggleModal, open }: ModalProps) {
  ...
  async function handleDelete() {
    if (currentUser) {
      setIsDeleting(true);
      await ShareBnbApi.deleteAccount(currentUser.username);
      setIsDeleting(false);
      logout();
      navigate("/");
    }
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={() => toggleModal(false)}>
        <Transition.Child
          as={Fragment}
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Are you sure you want to delete your account? All of the data will be permanently
